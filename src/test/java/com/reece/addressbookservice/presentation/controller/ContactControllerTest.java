...
import com.reece.addressbookservice.application.mapper.ContactMapperImpl;
...
public class ContactControllerTest {
    ...
    void getUniqueContacts_shouldReturnUniqueContacts() throws Exception {
        //given
        Contact contact1 = new Contact("test");
        Contact contact2 = new Contact("test");
        PhoneNo phoneNo = new PhoneNo("0402465555");
